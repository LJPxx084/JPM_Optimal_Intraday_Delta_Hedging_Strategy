...
2.5--4.5\% of the standardized loss at moderate widths, positive on every re-seeded
...
Combined dynamic   & $+0.3\%$ & $+0.8\%$ & $+1.2\%$ & $+1.5\%$ & $+3.0\%$  \\
\bottomrule
\end{tabular}
...
\textbf{combined dynamic band + edge targeting} ($H_0 = 5$, $c = 2$:
