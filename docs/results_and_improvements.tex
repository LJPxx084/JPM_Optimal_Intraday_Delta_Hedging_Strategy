...
(This is specific to ES's execution-cost scale: on the SPCX book, whose execution cost is
roughly a thousand times larger, the same per-order charge is negligible and a floor on
order splitting is required instead.)
