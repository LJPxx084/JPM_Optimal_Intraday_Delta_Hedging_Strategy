...
\cdot \frac{1}{1 + c\,\lvert\Gamma(t)\rvert/\tilde{\Gamma}},
\end{equation}
\end{eqbox}
...
isolates the timing information. The dynamic edge is real but depends on the width
regime: roughly 2--3\% of the standardized loss at $H_0 = 25$, up to about 6\% at wider
bands, and vanishing as bands tighten. It is positive for every dynamic form on every re-seeded
