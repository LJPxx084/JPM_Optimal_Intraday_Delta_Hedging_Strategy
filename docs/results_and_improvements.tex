...
All results below come from the backtesting framework of notebooks
\texttt{04\_alex\_implementation} and \texttt{05\_alex\_dynamic\_bands}: 102 trading days
...
with $\lambda = 1$, normalizing cost by Full Hedge and risk by Zero Hedge.
...
isolates the timing information. The dynamic edge is real but width-dependent:
$2.0$--$2.9\%$ of $L_{\text{std}}$ at $H_0 = 25$, up to $\approx 6\%$ at wider bands,
